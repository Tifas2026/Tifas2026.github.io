[ANLEITUNG.txt](https://github.com/user-attachments/files/32196540/ANLEITUNG.txt)
...
Dann Teilen, Herunterladen oder Oeffnen.

Der Dateiname entsteht automatisch nach dem Schema
    JJ.MM.TT_Maengelprotokoll-Wohnung_Projekt[_Gewerk].pdf
Beispiel: 26.09.09_Maengelprotokoll-WE16_Blickwinkel.pdf
Datum, Wohnung und Projekt kommen aus den Kopfdaten; bei der Variante
"Nur ein Gewerk" haengt das Gewerk hinten an. Umlaute werden umgeschrieben
(ae, oe, ue, ss), weil Chrome Dateinamen mit Sonderzeichen verwirft und die
Datei dann nur "download" heisst. Auf dem iPhone ist
